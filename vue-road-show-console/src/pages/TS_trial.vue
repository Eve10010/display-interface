    ...
    <div class="left">
      ...
      <div class="description">
        ...
        <p style="text-indent:-2em;padding:2em;align-self: start;">
          ...
          “HiPS+TSEngine-155M”指的是：在155M网络带宽下，HiPS框架中使用DGT调度算法进行分布式机器学习模型训练；<br>
          单轮迭代时间越少，模型训练越快。
        </p>
      </div>
    </div>
  ...
  methods: {
    ...
    initCharts1() {//考虑将四个柱状图分别用四个div写
      ...
      myChart1.setOption({
        tooltip: {},
        title: {
          text: '关于TSEngine算法的HiPS框架单轮迭代时间',
          textStyle: {
        ...
        xAxis: {
          type: 'category',
          data: ['HiPS-1G', 'HiPS-155M', 'HiPS+TSEngine-155M'],
          axisLabel: {
            fontSize: xAxis_size,
            interval: 0,
          },
